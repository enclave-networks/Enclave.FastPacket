...
namespace T
{
    readonly ref partial struct ValueItem
    {
        ...
        /// known fixed sizes.
        /// </summary>
        public const int MinimumSize = 20 + sizeof(ushort);
        ...
        {
           get => _span.Slice(0, DataSize);
        }
        
        
        public ushort DataSize
        {
           get => BinaryPrimitives.ReadUInt16BigEndian(_span.Slice(20));
           set => BinaryPrimitives.WriteUInt16BigEndian(_span.Slice(20), value); 
        }
        ...
        {
            return $"Value: {Value.Length} bytes; DataSize: {DataSize}";
        }
